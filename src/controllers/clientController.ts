...
router.get('/client',auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        res.status(httpStatus.INTERNAL_SERVER_ERROR).json({ message: "Error Clients" })
    }
});
...
router.get('/client/:id',auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        console.error(error.message);
        next(error);
        res.status(httpStatus.INTERNAL_SERVER_ERROR).json({ message: "Error Client" })
    }
});
...
router.post('/client',auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        console.error(error.message);
        next(error);
        res.status(httpStatus.INTERNAL_SERVER_ERROR).json({ message: "Error create Client" })
    }
});
...
router.put('/client',auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        console.error(error.message);
        next(error);
        res.status(httpStatus.INTERNAL_SERVER_ERROR).json({ message: "Error update Client" })
    }
});
...
router.delete('/client',auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        console.error(error.message);
        next(error);
        res.status(httpStatus.INTERNAL_SERVER_ERROR).json({ message: "Error delete Client" })
    }
});
