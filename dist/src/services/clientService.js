...
exports.deleteClient = exports.updateClient = exports.createClient = exports.getClient = exports.getAllClients = void 0;
...
var createClient = function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.client.create({ data: input })];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                error_3 = _a.sent();
...
var updateClient = function (id, input) { return __awaiter(void 0, void 0, void 0, function () {
    var error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.client.update({
                        where: { id: id },
                        data: input
                    })];
            case 1: return [2 /*return*/, _a.sent()];
...
var deleteClient = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.client.delete({
                        where: { id: id }
                    })];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
