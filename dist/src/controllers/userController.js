    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, userService_1.getUser)(id)];
            case 1:
                user = _a.sent();
            ...
            case 2:
                ...
                next(error_2);
                res.status(http_status_1.default.INTERNAL_SERVER_ERROR).json({ message: "Error User" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                next(error_3);
                res.status(http_status_1.default.INTERNAL_SERVER_ERROR).json({ message: "Error create User" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                next(error_4);
                res.status(http_status_1.default.INTERNAL_SERVER_ERROR).json({ message: "Error update User" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(0, validator_1.isIdValid)(id))
                    return [2 /*return*/, res.sendStatus(http_status_1.default.BAD_REQUEST)];
                return [4 /*yield*/, (0, userService_1.deleteUser)(id)];
            case 1:
                _a.sent();
                res.status(http_status_1.default.OK).json({ "message": "User eliminado.." });
                return [3 /*break*/, 3];
            case 2:
                error_5 = _a.sent();
                console.error(error_5.message);
                next(error_5);
                res.status(http_status_1.default.INTERNAL_SERVER_ERROR).json({ message: "Error delete User" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
