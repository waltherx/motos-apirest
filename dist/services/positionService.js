...
exports.deletePosition = exports.updatePosition = exports.createPosition = exports.getPosition = exports.getAllPositions = void 0;
...
var getPosition = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.position.findUnique({
                        where: { id: id },
                    })];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
...
var updatePosition = function (id, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.position.update({
                        where: { id: id },
                        data: input
                    })];
            case 1: return [2 /*return*/, _a.sent()];
...
var deletePosition = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.position.delete({
                        where: { id: id }
                    })];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
