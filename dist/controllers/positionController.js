...
router.get('/position/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, position, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                return [4 /*yield*/, (0, positionService_1.getPosition)(id)];
            case 1:
                position = _a.sent();
...
router.post('/position', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var client, newPosition, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                client = req.body;
                return [4 /*yield*/, (0, positionService_1.createPosition)(client)];
            case 1:
                newPosition = _a.sent();
